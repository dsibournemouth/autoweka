 ...
 */
public abstract class MultipleFilteredClassifiersCombiner extends AbstractClassifier {

  /** for serialization */
  private static final long serialVersionUID = 1531258531410902228L;
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (classifiers.size() == 0) {
      classifiers.addElement(new FilteredClassifier());
    }
    FilteredClassifier [] classifiersArray = new FilteredClassifier [classifiers.size()];
    for (int i = 0; i < classifiersArray.length; i++) {
      classifiersArray[i] = (FilteredClassifier) classifiers.elementAt(i);
    }
