...
public class ExperimentBuilder extends JFrame
{
    ...
    private JComboBox isAvatarOption;
  ...
  //-------------------------------------------------------------------------
    ...
    public void activateExperimentSettings()
    {
        ...
        if(classAttr.isNominal()){
            ...
            mResultMetricCombo.addItem(new StringComboOption("Area Above PRC (Classification)", "aoprc"));
        ...
        isAvatarOption.setModel(new DefaultComboBoxModel());
        isAvatarOption.addItem(new StringComboOption("true", "true"));
        isAvatarOption.addItem(new StringComboOption("false", "false"));
    ...
    public void writeExperimentFile()
    {
        ...
        String isAvatarStr = ((StringComboOption)isAvatarOption.getSelectedItem()).getData();
        LoggerUtil.logAvatar("isAvatarStr: " + isAvatarStr);
      
        if (isAvatarStr.equals("true")) {
            exp.isAvatar = true;
        } else {
            exp.isAvatar = false;
        }
