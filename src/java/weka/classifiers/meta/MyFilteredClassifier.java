 ...
 * Otherwise, the checking of applicability can fail if filter or classifier are
...
public class MyFilteredClassifier 
  ...
  public String toString() {
    ...
    if (m_FilteredInstances == null) {
      return "MyFilteredClassifier: No model built yet.";
    }

    String result = "MyFilteredClassifier using "
      + getClassifierSpec()
  ...
  public static void main(String [] argv)  {
    runClassifier(new MyFilteredClassifier(), argv);
  }
}