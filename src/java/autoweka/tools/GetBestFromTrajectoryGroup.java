...
public class GetBestFromTrajectoryGroup {
  ...
  public GetBestFromTrajectoryGroup(TrajectoryGroup trajGroup) {
	...
	&& !"NONE".equals(wekaArgs.propertyMap.get("attributesearch"))) {
      attributeSearchClass = wekaArgs.propertyMap.get("attributesearch");
      attributeSearchArgs = Util.joinStrings(" ",
	  Util.quoteStrings(wekaArgs.argMap.get("attributesearch")));

      attributeEvalClass = wekaArgs.propertyMap.get("attributeeval");
      attributeEvalArgs = Util.joinStrings(" ",
	  Util.quoteStrings(wekaArgs.argMap.get("attributeeval")));
    }
    ...
    totalNumEval = trajGroup.getNumEvaluations();
  }
  ...
  public static void main(String[] args){
        ...
        System.out.println("Num Evaluations (for that seed): " + res.numEval);
        System.out.println("Num Evaluations (in total): " + res.totalNumEval);
