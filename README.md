...
## About this branch
This branch contains the updates for supporting adaptation of MCPS in Auto-WEKA. Adaptive experiments have only been tested on SMAC, but it is expected to work in the rest of optimisation strategies with minor or none modifications.
...
## Publications
 * Manuel Martin Salvador, Marcin Budka, and Bogdan Gabrys. "Effects of change propagation resulting from adaptive preprocessing in multicomponent predictive systems". Accepted in KES 2016.
 * Manuel Martin Salvador, Marcin Budka, and Bogdan Gabrys. "Adapting Multicomponent Predictive Systems using Hybrid Adaptation Strategies with Auto-WEKA in Process Industry". Accepted in AutoML workshop at ICML 2016. [[results](https://github.com/dsibournemouth/autoweka/tree/feature/batch-adaptation/results)]
